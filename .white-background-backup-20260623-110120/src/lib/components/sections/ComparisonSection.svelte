...
<section id="portfolio" class="relative flex w-full flex-col items-center gap-[10px] overflow-hidden bg-[#edf8f4] px-[50px] py-[100px] scroll-mt-[100px] max-md:px-[18px] max-md:py-[80px]">
