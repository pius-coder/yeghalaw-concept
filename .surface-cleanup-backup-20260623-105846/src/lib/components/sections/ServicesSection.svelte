...
<section id="services" class="bg-[radial-gradient(circle_at_8%_10%,rgba(20,184,166,0.13),transparent_30%),radial-gradient(circle_at_92%_85%,rgba(249,115,22,0.13),transparent_32%),#edf8f4] px-[50px] py-[100px] scroll-mt-[100px]">
