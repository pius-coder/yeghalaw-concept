...
<div
	class="flex w-full flex-col gap-6 rounded-[10px] border border-white/80 bg-[linear-gradient(145deg,#ffffff_0%,#fff9f2_48%,#f2eeff_100%)] p-5 shadow-[inset_3px_3px_47px_5px_rgba(255,255,255,0.65)]"
>
